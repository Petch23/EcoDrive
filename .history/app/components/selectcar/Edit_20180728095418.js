...
export class Edit extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
          selected: this.props.editdetail.CO2Emission
        };
      }
      ...
      <View style={styles.mainviewStyle}>
        ...
        <View>
            ...
            >
              ...
              <Picker.Item label="Diesel" value={['Diesel',2600]} />
              <Picker.Item label="E20" value={['E20',2300]} />
              <Picker.Item label="E85" value={['E85',2360]}/>
            </Picker>
            </ListItem>
            </List>
        </View>
