      ...
      <View style={styles.mainviewStyle}>
        ...
        <View>
          ...
          <TouchableHighlight style={styles.bottomButtons} onPress={Actions.selectmycar}>
              <Text style={styles.footerText}>{this.props.text.Make === undefined && this.props.text.Model === undefined ? 'SelectCar' :this.props.text.Make+" "+this.props.text.Model }</Text>
          </TouchableHighlight>
          <TouchableHighlight style={styles.bottomButtons} onPress={Actions.editcar}>
