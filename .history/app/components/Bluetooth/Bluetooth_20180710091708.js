  ...
  componentWillMount () {
    ...
    BluetoothSerial.on('connectionLost', () => {
      if (this.props.device) {
        Toast.showShortBottom(`Connection to device ${this.props.device.name} has been lost`)
      }
        ...
        ? (
          <View style={[styles.topBar, { justifyContent: 'center', paddingHorizontal: 0 }]}>
            ...
            <TouchableOpacity style={[styles.tab, this.props.section === 1 && activeTabStyle]} onPress={this.props.sec1}>
              <Text style={{ fontSize: 14, color: '#FFFFFF' }}>{this.props.unpairedDevices.name}</Text>
            </TouchableOpacity>
          </View>
        ) : null}
